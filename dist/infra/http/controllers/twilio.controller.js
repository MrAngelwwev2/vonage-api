...
Object.defineProperty(exports, "TwilioController", {
    enumerable: true,
    get: function() {
...
], TwilioController.prototype, "getAll", null);
_ts_decorate([
    (0, _common.Post)(''),
    ...
    _ts_metadata("design:returntype", void 0)
], TwilioController.prototype, "create", null);
TwilioController = _ts_decorate([
    (0, _common.Controller)('/twilio'),
    (0, _swagger.ApiTags)('Twilio'),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
